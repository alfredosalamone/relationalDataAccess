...
public class GsRelationalDataAccessApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		List<Object[]> splitUpNames = Arrays.asList("Alfredo Salamone", "Simona Saccullo", "Enza Platino", "Adele Olla").stream()
				.map(name -> name.split(" "))
		...
		log.info("Querying for customer records where first_name = 'Alfredo'");

		jdbcTemplate.query("SELECT id, first_name, last_name from customers where first_name = ?", new Object[] {"Alfredo"},
